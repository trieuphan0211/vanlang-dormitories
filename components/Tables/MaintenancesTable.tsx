"use client";
import { AddNewMaintenance } from "@/components/Form/AddNewMaintenance";
    ...
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <tbody>
            {maintenances.map((maintenance, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">
                    {maintenance.updateDate.getDate() +
                      "/" +
                      (maintenance.updateDate.getMonth() + 1) +
                      "/" +
                      maintenance.updateDate.getFullYear()}
                  </p>
                </td>
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <p
                  ...
                  >
                    {maintenance.status === "CREATED" && "Đang chờ xử lý"}
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div>
                    <IconButton
                      ...
                      // aria-haspopup="true"
                      onClick={(e) => handleClick(e, maintenance.id)}
                    >
                      <MdMoreVert />
                    </IconButton>
                    <Menu
                        ...
                        <>
                          <MenuItem onClick={handleClose}>
                            <button
                              ...
                              onClick={() => {
                                router.push(
                                  `/admin/maintenance/detail/${maintenanceId}`,
                                );
                              }}
                            >
                              <svg
      ...
      {openRemove && (
        <RemoveItemDialog
          ...
          title={"Bạn có chắc chắn muốn xóa bảo trì này không?"}
        />
      )}
    </div>
  );
