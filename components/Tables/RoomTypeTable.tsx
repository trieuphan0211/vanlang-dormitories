...
export const RoomTypeTable = ({
  ...
  // state to get roomTypeId when showing action menu
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <tbody>
            {roomTypes.map((roomType, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <p className="text-black dark:text-white">{roomType.name}</p>
                </td>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div>
                    <IconButton
                      ...
                      // aria-haspopup="true"
                      onClick={(e) => handleClick(e, roomType.id)}
                    >
                      <MdMoreVert />
                    </IconButton>
                    <Menu
                    ...
                    >
                      <MenuItem onClick={handleClose}>
                        <button
                          ...
                          onClick={() => {
                            router.push(
                              `/admin/room-type/detail/${roomTypeId}`,
                            );
                          }}
                        >
                          <svg
                      ...
                      <MenuItem onClick={handleClose}>
                        <button
                          ...
                          disabled={isPending}
                          onClick={() => {
                            router.push(`/admin/room-type/${roomTypeId}`);
                          }}
                        >
                          <FaRegEdit />
      ...
      {roomTypes.length > 0 && <Pagination count={count} />}
      {openRemove && (
        <RemoveItemDialog
          isPending={isPending}
          startTransition={startTransition}
          ...
          title={"Bạn có chắc chắn muốn xóa loại phòng này không?"}
        />
      )}
    </div>
  );
