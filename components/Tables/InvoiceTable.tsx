...
import { ResendMail } from "../Dialog/ResendMail";
import { set } from "zod";
...
export const InvoiceTable = ({
  ...
  const [openResend, setOpenResend] = useState<Boolean>(false);
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
                      ...
                      >
                        <MenuItem
                          ...
                          onClick={() => {
                            ...
                            type !== "user"
                              ...
                              : router.push(
                                  `/home/invoice/detail/${invoiceId}`,
                                );
                          }}
                        >
                          <button className="flex w-full items-center gap-3 rounded-xl text-green-600 focus:outline-none">
                            <svg
                        ...
                        {type !== "user" && (
                          <>
                            ...
                            >
                              <button className="flex w-full items-center justify-start gap-3 rounded-xl text-rose-600 focus:outline-none">
                                <svg
                                  className="fill-current"
                                  width="18"
                                  height="18"
      ...
      {openCheck && (
        <CheckInvoice
          title={"Bạn có chắc chắn muốn xác nhận hóa đơn này không ?"}
          startTransition={startTransition}
          isPending={isPending}
          invoiceId={invoiceId}
