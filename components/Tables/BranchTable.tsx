  ...
  return (
    <div className=" rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="mb-5 flex w-full gap-3">
        ...
        <AddNewItem isPending={isPending} startTransition={startTransition} />
      </div>
            ...
            {branchs.map((branch, key) => {
              ...
              return (
                <tr key={key}>
                  ...
                  <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                    <p className="text-black dark:text-white">{branch.name}</p>
                  </td>
                  ...
                  <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                    <div className="flex items-center space-x-3.5">
                      <button
                        ...
                        disabled={isPending}
                        onClick={() => {
                          router.push(`/admin/branch/detail/${branch.id}`);
                        }}
                      >
                        <svg
                      ...
                      <button
                        ...
                        disabled={isPending}
                        onClick={() => {
                          router.push(`/admin/branch/${branch.id}`);
                        }}
                      >
                        <FaRegEdit />
                      </button>
                      <RemoveItem
                        ...
                        branchId={branch.id}
                        title={"Bạn có chắc chắn muốn xóa chi nhánh này không?"}
                      />
                    </div>
                  </td>
                </tr>
      ...
      {branchs.length > 0 && <Pagination count={count} />}
    </div>
  );
};
