...
export const FacilitiesTypeTable = ({
  ...
  const [facilitiesTypeId, setFacilitiesTypeId] = useState<string>("");
  //Handle set position action menu
  const handleClick = (event: React.MouseEvent<HTMLElement>, id: string) => {
    setFacilitiesTypeId(id);
  ...
  return (
    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
      <div className="mb-5 flex w-full justify-between gap-3 sm:flex-col">
        <SearchTable
          placeholder="Tìm kiếm tên loại cơ sở vật chất ..."
          type="facilitiesType"
        />
        <DialogButton
          open={open}
      ...
      <div className="max-w-full overflow-x-auto">
        <table className="w-full table-auto">
          ...
          <tbody>
            {facilitiesTypes.map((facilitiesType, key) => (
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div>
                    <IconButton
                      ...
                      // aria-haspopup="true"
                      onClick={(e) => handleClick(e, facilitiesType.id)}
                    >
                      <MdMoreVert />
                    </IconButton>
                    <Menu
                    ...
                    >
                      <MenuItem onClick={handleClose}>
                        <button
                          ...
                          onClick={() => {
                            router.push(
                              `/admin/facilities-type/detail/${facilitiesTypeId}`,
                            );
                          }}
                        >
                          <svg
                      ...
                      <MenuItem onClick={handleClose}>
                        <button
                          ...
                          onClick={() => {
                            router.push(
                              `/admin/facilities-type/${facilitiesTypeId}`,
                            );
                          }}
                        >
                          <FaRegEdit />
      ...
      {facilitiesTypes.length > 0 && <Pagination count={count} />}
      {openRemove && (
        <RemoveItemDialog
          isPending={isPending}
          startTransition={startTransition}
          ...
          title={"Bạn có chắc chắn muốn xóa loại cơ sở vật chất này không?"}
        />
      )}
    </div>
  );
