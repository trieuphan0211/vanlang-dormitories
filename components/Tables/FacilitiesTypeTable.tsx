                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <button
                      ...
                      onClick={() =>
                        router.push(
                          `/admin/facilities-type/detail/${facilitiesType.id}`,
                        )
                      }
                    >
                      <svg
                    ...
                    <button
                      ...
                      onClick={() =>
                        router.push(
                          `/admin/facilities-type/${facilitiesType.id}`,
                        )
                      }
                    >
                      <FaRegEdit />
                    ...
                    <RemoveItem
                      isPending={isPending}
                      startTransition={startTransition}
                      facilitiesTypeId={facilitiesType.id}
                      title={
                        "Bạn có chắc chắn muốn xóa loại cơ sở vật chất này không?"
                      }
                    />
                  </div>
                </td>
