        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              <Link
                className="mb-5.5 flex h-22 items-center justify-center overflow-hidden"
                href="/"
              >
                <Image
                  className=""
              ...
              <p className="max-w-180">
                Van Lang University dormitories aim for a dynamic, autonomous
                style, honoring the independent lifestyle and unique color of
                each student in the Van Lang community.
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <Link
                className="mb-5.5 flex h-22 items-center justify-center overflow-hidden xl:hidden"
                href="/"
              >
                <Image
                  className=""
