          ...
          <Section style={content}>
            ...
            <Row style={{ ...boxInfos, paddingBottom: "0" }}>
              <Column>
                ...
                >
                  Chúng tôi xin trân trọng thông báo rằng bạn đã đăng ký phòng
                  tại Ký túc xá Trường Đại học Văn Lang.
                </Heading>
                ...
                >
                  *Lưu ý: Đây là email tự động, vui lòng không trả lời.
                </Text>

                <Text style={paragraph}>
                  Nếu có bất cứ thắc mắc nào, vui lòng liên hệ với chúng tôi qua
                  email <Link style={link}>ktx.vanlanguni@gmail.com</Link> hoặc
                  số điện thoại <Link style={link}>0372 106 260</Link>{" "}
                </Text>
                <Text style={{ ...paragraph, marginTop: -5 }}>
